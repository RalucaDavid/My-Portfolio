...
const Projects = () => {
  return (
    <div className={classes.projectsWrapper}>
      <Text className={classes.title}>{Dictionary.projects}</Text>
      <div className={classes.projectsContainer}>
        ...
        {specialProjects.slice(1, 2).map((project, index) => (
          <Project
            ...
            description={project.description}
            name={project.name}
            buttonText={Dictionary.presentationVideo}
            technologies={project.technologies}
            key={index}
          ></Project>
        ))}
        ...
        {specialProjects.slice(2, 3).map((project, index) => (
          <Project
            src={project.src}
            link={project.link}
            description={project.description}
            name={project.name}
            buttonText={Dictionary.rightHere}
            technologies={project.technologies}
            key={index}
          ></Project>
        ))}
